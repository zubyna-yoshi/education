...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .home-grid {{ display: grid; grid-template-columns: 1.1fr .9fr; gap: 14px; align-items: center; }}
    ...
    .home-img {{ width: 100%; border: 1px solid #d7e2f0; border-radius: 12px; overflow: hidden; min-height: 220px; background: #eef4fb; }}
    ...
    <div id=\"homeScreen\" class=\"home\">
      <div class=\"home-grid\">
        <div>
          ...
          <button id=\"startBtn\" type=\"button\">조항 적용 시작</button>
        </div>
